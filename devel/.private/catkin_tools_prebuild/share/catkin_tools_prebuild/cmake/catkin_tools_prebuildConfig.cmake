...
if("TRUE" STREQUAL "TRUE")
  set(catkin_tools_prebuild_SOURCE_PREFIX /mnt/storage_disk/MMRS_public/build/catkin_tools_prebuild)
  set(catkin_tools_prebuild_DEVEL_PREFIX /mnt/storage_disk/MMRS_public/devel/.private/catkin_tools_prebuild)
  ...
  set(catkin_tools_prebuild_INSTALL_PREFIX /mnt/storage_disk/MMRS_public/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'catkin_tools_prebuild' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/mnt/storage_disk/MMRS_public/build/catkin_tools_prebuild/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /mnt/storage_disk/MMRS_public/devel/.private/catkin_tools_prebuild/lib;/home/uib/MRS_ws/devel/lib;/opt/ros/melodic/lib)
